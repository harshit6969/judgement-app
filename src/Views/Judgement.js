  ...
  updateScorecard(data) {
    ...
    if (this.state.RoundInProgress) {
      ...
      let state = {
        ...
        currentRounds: this.state.currentRounds + 1,
        RoundInProgress: false,
        openPlayerHandler: false,
      ...
      <Grid container direction="row" justify="center" alignItems="center">
          ...
          >
            ...
            {this.state.currentRounds > 0 ? (
              ...
              <BottomNavigationAction
                ...
                onClick={() => this.setState({ openPlayerHandler: true })}
              />
            )}
                  ...
                  >
                    ...
                    <Grid item>
                      <Switch
                        ...
                        onChange={() =>
                          this.setState({ openPlayerHandler: true })
                        }
                        value="Start"
                      />
                    </Grid>
        ...
        <Grid container direction="row">
                      ...
                      <ListItem alignItems="flex-start">
                        <ListItemAvatar>
                          <Avatar
                            variant="square"
                            style={
                              this.state.trump_color
                                ? { backgroundColor: this.state.trump_color }
                                : {}
                            }
                          >
                            {this.state.TotalRoundScore}
                          </Avatar>
                        </ListItemAvatar>
                        <ListItemText
                          primary={"Hands total"}
          ...
          <Grid
            ...
            alignItems="stretch"
          >
            {/* <List style={{height: '100%'}} alignItems="stretch"> */}
